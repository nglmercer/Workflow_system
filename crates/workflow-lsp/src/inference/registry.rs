...
impl FunctionRegistry {
    ...
    pub fn register_standard_builtins(&self) {
        ...
        // Core functions
        inner.builtins.insert("log".to_string(), FunctionEntry {
            name: "log".to_string(),
        ...
        inner.builtins.insert("len".to_string(), FunctionEntry {
            name: "len".to_string(),
            params: vec![ParamDescriptor {
        ...
        inner.builtins.insert("to_string".to_string(), FunctionEntry {
        ...
        inner.builtins.insert("to_number".to_string(), FunctionEntry {
        ...
        inner.builtins.insert("emit".to_string(), FunctionEntry {
            name: "emit".to_string(),
            params: vec![ParamDescriptor {
        ...
        // String functions
        inner.builtins.insert("concat".to_string(), FunctionEntry {
        ...
        inner.builtins.insert("join".to_string(), FunctionEntry {
            name: "join".to_string(),
            params: vec![
                ParamDescriptor {
        ...
        inner.builtins.insert("split".to_string(), FunctionEntry {
        ...
        inner.builtins.insert("trim".to_string(), FunctionEntry {
            name: "trim".to_string(),
            params: vec![ParamDescriptor {
                name: "string".to_string(),
                ty: Type::String,
        ...
        inner.builtins.insert("upper".to_string(), FunctionEntry {
        ...
        inner.builtins.insert("lower".to_string(), FunctionEntry {
        ...
        inner.builtins.insert("replace".to_string(), FunctionEntry {
        ...
        inner.builtins.insert("contains".to_string(), FunctionEntry {
        ...
        inner.builtins.insert("substr".to_string(), FunctionEntry {
        ...
        // Math functions
        inner.builtins.insert("abs".to_string(), FunctionEntry {
            name: "abs".to_string(),
            params: vec![ParamDescriptor {
                name: "value".to_string(),
                ty: Type::Number,
        ...
        inner.builtins.insert("ceil".to_string(), FunctionEntry {
            name: "ceil".to_string(),
            params: vec![ParamDescriptor {
                name: "value".to_string(),
                ty: Type::Number,
        ...
        inner.builtins.insert("floor".to_string(), FunctionEntry {
        ...
        inner.builtins.insert("round".to_string(), FunctionEntry {
        ...
        inner.builtins.insert("max".to_string(), FunctionEntry {
            name: "max".to_string(),
            params: vec![
                ParamDescriptor {
                    name: "a".to_string(),
        ...
        inner.builtins.insert("min".to_string(), FunctionEntry {
            name: "min".to_string(),
            params: vec![
                ParamDescriptor {
                    name: "a".to_string(),
        ...
        inner.builtins.insert("random".to_string(), FunctionEntry {
        ...
        // Array functions
        inner.builtins.insert("sort".to_string(), FunctionEntry {
            name: "sort".to_string(),
            params: vec![ParamDescriptor {
                name: "array".to_string(),
                ty: Type::Array(Box::new(Type::Any)),
        ...
        inner.builtins.insert("reverse".to_string(), FunctionEntry {
        ...
        inner.builtins.insert("push".to_string(), FunctionEntry {
            name: "push".to_string(),
            params: vec![
                ParamDescriptor {
                    name: "array".to_string(),
        ...
        inner.builtins.insert("pop".to_string(), FunctionEntry {
            name: "pop".to_string(),
            params: vec![ParamDescriptor {
                name: "array".to_string(),
                ty: Type::Array(Box::new(Type::Any)),
        ...
        inner.builtins.insert("map".to_string(), FunctionEntry {
            name: "map".to_string(),
            params: vec![
                ParamDescriptor {
                    name: "array".to_string(),
        ...
        inner.builtins.insert("filter".to_string(), FunctionEntry {
        ...
        inner.builtins.insert("reduce".to_string(), FunctionEntry {
        ...
        // JSON functions
        inner.builtins.insert("parse".to_string(), FunctionEntry {
        ...
        inner.builtins.insert("stringify".to_string(), FunctionEntry {
        ...
        // Type functions
        inner.builtins.insert("type_of".to_string(), FunctionEntry {
    ...
    pub fn register_from_sig(&self, sig: &FunctionSig, is_user_defined: bool) {
        let entry = FunctionEntry {
            name: sig.name.clone(),
            params: sig.params.iter().enumerate().map(|(i, name)| ParamDescriptor {
                name: name.clone(),
    ...
    pub fn get(&self, name: &str) -> Option<FunctionEntry> {
        ...
        inner.functions.get(name).or_else(|| inner.builtins.get(name)).cloned()
    }
    ...
    pub fn function_names(&self) -> Vec<String> {
        let inner = self.inner.read().unwrap();
        let mut names: Vec<String> = inner.functions.keys().chain(inner.builtins.keys()).cloned().collect();
        names.sort();
        names.dedup();
        names
    }
